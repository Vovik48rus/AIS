...
public:
  // GenericTimer *timerSurvey;
  // GenericTimer *timerWatering;
  // GenericTimer *timerAbsorption;

public:
  Pot(string name, Logger *logger, Pump *pump, CSMS *myCSMS, int threshold, int surveyTime, int wateringTime, int absorptionTime)
